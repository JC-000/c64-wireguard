...
**On a `UCI_CHUNKED_WRITE=1` build the peer needs no MTU change at all** — see "Chunked send" below; this only applies to a device running the [#807](https://github.com/GideonZ/1541ultimate/issues/807) spike firmware, not released 3.15.
