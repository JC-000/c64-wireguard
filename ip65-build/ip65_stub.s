...
; Produces a raw binary at $2000, .incbin'd by src/net/ip65/ip65_blob.s.
;
...
; =============================================================================
; Jump table at $2000 — 3-byte JMP entries, called from WG code
; =============================================================================
.segment "JUMPTAB"
...
; Each entry is a 2-byte address (lo/hi) — WG code reads from known offsets
